...
- [v4 NLU + Personality](v4-nlu-personality.md) — language detector (runtime Tenglish/Hinglish/Tamilish), GET_DETAILS/OPEN_QUESTION intent patterns, v4 SYSTEM_PROMPT key decisions.
